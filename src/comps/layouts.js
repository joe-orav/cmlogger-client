            ...
            <nav className="cm-navbar">
                ...
                <div className="collapse navbar-collapse" id="cm-navbar-toggler">
                    <div className="cl-nav-items">
                        ...
                        <Link to="/cars" className="nav-item nav-link"><i className="fas fa-car"></i> My Cars</Link>
                        <Link to="/service-history" className="nav-item nav-link"><i className="fas fa-wrench"></i> Service History</Link>
                    </div>
                </div>
            </nav>
